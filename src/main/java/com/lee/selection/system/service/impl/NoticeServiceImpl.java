...
import com.lee.selection.system.converter.NoticeConverter;
...
public class NoticeServiceImpl extends ServiceImpl<NoticeMapper, Notice> implements NoticeService {
    ...
    */
    ...
    public boolean saveNotice(NoticeForm formData) {
        ...
        adminQueryWrapper.eq("code",username);
        User user = userService.getOne(adminQueryWrapper);

        formData.setPublisher(user.getId());
