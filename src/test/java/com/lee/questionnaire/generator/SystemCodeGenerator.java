package com.lee.questionnaire.generator;
...
public class SystemCodeGenerator {
    ...
    private static final DataSourceConfig.Builder DATA_SOURCE_CONFIG = new DataSourceConfig
            .Builder("jdbc:mysql://localhost:3306/questionnaire_system?serverTimezone=Asia/Shanghai", "root", "1234");
    ...
    public static void main(String[] args) {
        FastAutoGenerator.create(DATA_SOURCE_CONFIG)
                ...
                .packageConfig(builder -> {
                            builder
                                    .parent("com.lee.questionnaire.system")
                                    .entity("model.entity")
                                    .mapper("mapper")
                                    .service("service")
...
//                   customFiles.add(new CustomFile.Builder().fileName("Converter.java").templatePath("/templates/converter.java.vm").packageName("converter").build());
                    ...
                    consumer.beforeOutputFile((tableInfo, objectMap) -> {
                        ...
                        String commonPackageName = "com.lee.questionnaire";
                ...
                .strategyConfig((scanner, builder) -> {
                           ...
                           // builder.addTablePrefix("t_") // 过滤移除表前缀 sys_user 表生成的实体类 User.java
